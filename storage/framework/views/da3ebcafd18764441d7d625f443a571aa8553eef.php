<div class="Estimate_area overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-8 col-md-7">
                    <div class="form">
                        <form action="<?php echo e(url('estimate')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-xl-6">
    ...
    </div><?php /**PATH E:\totorial\global-transport\resources\views/user/estamit.blade.php ENDPATH**/ ?>