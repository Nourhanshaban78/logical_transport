...
<body>
                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                       ...
                                       <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                                        ...
                                        <li><a href="<?php echo e(url('/my_est')); ?>">MY Estamite</a></li>
                                        <li><a href="<?php echo e(url('/opinion')); ?>">Opinion</a></li>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_transport">
                        ...
                        <p>It is an essential part of modern society and plays a crucial role in the economy, social activities,
                             and daily life of people..</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_transport">
                        ...
                        <p>Live monitoring can help organizations make informed decisions and take quick action based on the real-time data. 
                            It can also help identify and address potential issues before they become more significant problems.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_transport">
                        ...
                        <p>the provision of products or services to customers around the world. It means that a company has the capability to operate and deliver its services or products to customers in different countries and regions,
                             regardless of geographical distances or cultural differences..</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php echo $__env->make('user.fight', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="row  align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="features_info">
                            <h3>Why Choose Us?</h3>
                            <p>Speed ​​in performance and accuracy in work
                            </p>
                            <ul>
    ...
    <?php echo $__env->make('user.test', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- /testimonial_area  -->

    <!-- Estimate_area start  -->
   <?php echo $__env->make('user.estamit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- Estimate_area end  -->
...
</html><?php /**PATH E:\totorial\global-transport\resources\views/user/home.blade.php ENDPATH**/ ?>